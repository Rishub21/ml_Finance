...
def scraper(ticker):
    ...
    url = "http://financials.morningstar.com/ratios/r.html?t=" + ticker +"&region=usa&culture=en-US"
    url = "http://financials.morningstar.com/ratios/r.html?t=AAPL&region=usa&culture=en-US"
    url = "http://financials.morningstar.com/ajax/exportKR2CSV.html?&callback=?&t=XNAS:AAPL&region=usa&culture=en-US&cur=&order=asc"
    content = urllib2.urlopen(url).read()
    directory = "morningstar/" + ticker + ".csv"
    with open(directory,"wb+") as stockdir:
        stockdir.write(content)
...
with open("morningstar/AA.csv", "r") as filename:
...
os.remove("morningstar/AA.csv")

with open("morningstar/AA.csv","wb+") as stockfile:
    for line in lines:
        stockfile.write(line)


df = pd.read_csv("morningstar/A.csv")
...
#print df
lister2 =  df.ix["Revenue USD Mil"].index.tolist()
#print lister2
#print df.ix["Revenue USD Mil"]
# 5 is EPS,
for i in lister2:
    tup = (i, df.ix[5][i])
    print tup
